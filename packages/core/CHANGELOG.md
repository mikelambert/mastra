...
- Add clone agent feature. Code-defined or stored agents can be cloned into new stored agents via a "Clone" button in the playground or the client SDK: ([#12796](https://github.com/mastra-ai/mastra/pull/12796))
